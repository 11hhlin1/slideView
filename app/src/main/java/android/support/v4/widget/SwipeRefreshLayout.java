...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    private void ensureTarget() {
        ...
        // out yet.
        if (mTarget == null) {
            CircleImageView circleView = this.mCircleView;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                float xDiff = getMotionEventX(ev, mActivePointerId) - mInitialDownX;
                if (yDiff > mTouchSlop && !mIsBeingDragged && Math.abs(yDiff) > Math.abs(xDiff)) {
